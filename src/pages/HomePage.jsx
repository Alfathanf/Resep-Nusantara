  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 pb-20 md:pb-8">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 space-y-12 md:space-y-16">
        <FeaturedMakananSection featuredMakanan={featuredMakanan} onRecipeClick={onRecipeClick} />
        <FeaturedMinumanSection featuredMinuman={featuredMinuman} onRecipeClick={onRecipeClick} />
      </main>
    </div>
  );
}